      ...
      <div className='w-full flex flex-col max-w-[1200px] justify-center items-center'>
        <div className='my-3 justify-center items-center flex flex-col w-full rounded-lg mb-auto'>
          <div className='w-11/12 p-8 my-3 rounded-lg bg-black text-white'>
            <p className='font-semibold mb-3 text-[18px]'>My Orders</p>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 font-semibold'>
              <div className='flex flex-col justify-center items-center p-5 bg-white text-black rounded-lg'>
                ...
                <p className='ml-3 mt-2 mr-auto text-[12.5px] h-[50px] overflow-hidden'> to know if I'm doing something wrong to know if I'm doing something wrong to know if I'm doing something wrong</p>
              ...
              </div><div className='flex flex-col justify-center items-center p-5 bg-white text-black rounded-lg'>
                <div className='flex flex-row items-center gap-2 mr-auto md:ml-2'>
                  <Image src={'/images/pfp.png'} alt='pfp' className='h-[35px] w-[35px] border-2 border-green-400 rounded-full' height={1000} width={1000} />
                  <div>
                    <p className='text-[13px]'>Jane Doe</p>
