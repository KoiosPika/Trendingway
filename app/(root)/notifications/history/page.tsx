                            ...
                            {history.map((request: IRequest) => (
                                <div key={request._id} className='flex flex-col justify-center items-center p-5 bg-white text-black rounded-lg border-[0.5px] border-gray-400' style={{ boxShadow: '0 8px 10px -6px gray, -8px 8px 8px -6px gray, 8px 8px 8px -6px gray' }}>
                                    <div className='flex flex-row items-center gap-2 mr-auto md:ml-2 w-full'>
                                        ...
                                        {request.type === 'LongVideoReview' && <Image src={'/icons/video.svg'} alt='video' width={200} height={200} className='bg-[#B69615] w-[40px] h-[40px] p-1.5 rounded-full ml-auto' />}
                                    ...
                                    {request.status === 'Reviewed' && <Button className='bg-blue-500 w-full flex flex-row items-center justify-center gap-2 py-1 rounded-lg mt-4 mb-2 hover:cursor-default hover:bg-blue-500'>
                                    <Image src={'/icons/star-white.svg'} alt='star' height={15} width={15} />
                                        <p className='text-[13px] md:text-[16px] text-white font-bold'>Reviewed</p>
                                    </Button>}
