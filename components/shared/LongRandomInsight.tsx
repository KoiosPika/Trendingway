...
const LongRandomInsight = ({ price, userId, insighter }: { price: number, userId: string, insighter: string }) => {
    ...
    const handleRequest = async () => {
        ...
        const response = await createRequest({ User: userId, Insighter: insighter, postLink: URL, description, platform, price, type: 'LongRandomInsight' });
...
export default LongRandomInsight