        ...
        <div className='w-full h-full flex justify-center items-center bg-white'>
            <div className='w-full flex flex-col max-w-[900px] justify-center items-center'>
                <div className='my-3 justify-center items-center flex flex-col w-full'>
                    <div className='flex flex-col justify-center items-center my-[50px] md:p-3 w-full md:w-4/5 bg-yellow-400 md:rounded-lg rounded-0'>
                        <div className='flex justify-center items-center my-2'>
                            <p className='font-semibold text-[35px]'>Contact Form</p>
                        </div>
                        ...
                        {!Loading && <Button onClick={handleEmail} className='my-5 bg-white border-2 hover:border-white text-black hover:text-white w-2/5 text-center p-2 rounded-lg'>
