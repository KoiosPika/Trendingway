        ...
        <div className='w-full h-full flex justify-center items-center bg-white'>
            <div className='w-full flex flex-col max-w-[900px] justify-center items-center'>
                <div className='my-3 justify-center items-center flex flex-col w-full'>
                    <div className='rounded-lg flex flex-col justify-center items-center my-[50px] md:p-3 w-full md:w-4/5 bg-yellow-400 md:border-[2px] border-slate-300' style={{ boxShadow: '0 8px 10px -6px gray, -8px 8px 8px -6px gray, 8px 8px 8px -6px gray' }}>
                        <div className='flex flex-row items-center text-black text-[35px] font-bold gap-1 py-2'>
                            <p className='bg-white px-4 py-1 rounded-lg border-[1px] border-black'>Contact Us</p>
                        </div>
                        ...
                        {!Loading && <Button onClick={handleEmail} className='my-5 bg-white hover:bg-yellow-400 text-black w-2/5 text-center p-2 rounded-lg'>
                            <p className='font-semibold text-[16px]'>Submit</p>
                        </Button>}
                        {Loading && <Button disabled className='my-5 bg-white hover:bg-yellow-400 text-black w-2/5 text-center p-2 rounded-lg'>
