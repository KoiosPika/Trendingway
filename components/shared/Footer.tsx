...
const Footer = () => {
    return (
        <footer className="bg-[#1A1A2E] text-white py-4 px-6"> {/* Use your brand colors */}
            <div className="max-w-7xl mx-auto flex flex-col space-y-4 md:space-y-0 md:flex-row md:justify-between md:items-center">
                ...
                <Image className='h-[70px] w-[70px] bg-black rounded-full' src={'/images/uncut.png'} alt='logo' height={1000} width={1000} />
                </div>
