    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="bg-white border-0">
                ...
                <p className='font-semibold'>Your order was canceled and ${request?.price} we're refunded to your current balance</p>
                <p className='font-semibold'>Reason for canceling:</p>
                <div className='w-full bg-white flex items-center gap-2 rounded-b-lg'>
                    <Link href={`/profile/${request?.Reviewer?.username}`} className='h-[45px] w-[45px]'>
