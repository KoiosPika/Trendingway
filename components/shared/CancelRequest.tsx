...
const CancelRequest = ({ request }: { request: string }) => {
    ...
    return (
        <Button className='bg-red-500 w-1/6 flex flex-row items-center justify-center gap-2 py-1 rounded-lg mt-4 mb-2 hover:cursor-pointer hover:bg-red-500' onClick={handleCancelingRequest}>
